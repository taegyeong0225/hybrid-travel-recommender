...
visit_F = pd.read_csv(os.path.join(DATA_DIR, "tn_visit_area_info_F.csv"))
...
df1.to_csv(os.path.join(PREPROC_DIR, "dfF.csv"))
...
file_path = os.path.join(SAVEMODEL_DIR, 'model/svd_model_F.pkl')
# Save the model to the specified .pkl file
with open(file_path, 'wb') as file:
    pickle.dump(algo, file)

loaded_model1 = joblib.load(os.path.join(SAVEMODEL_DIR, 'model/svd_model_F.pkl'))
...
df_F_final.to_csv(os.path.join(SAVEMODEL_DIR, 'result/testset_output/F_test_ouput.csv'))
...
filtered_top_recommendations.to_csv(os.path.join(SAVEMODEL_DIR, 'result/final_output/F_top_recommendations.csv'))
